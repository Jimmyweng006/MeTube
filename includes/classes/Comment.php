...
class Comment {
    ...
    public function getNumberOfReplies() {
        $query = $this->con->prepare("SELECT * FROM comments WHERE responseTo = :id");
    ...
    public function getLikes() {
        $query = $this->con->prepare("SELECT * FROM likes WHERE commentId = :commentId");
        $query->bindParam(":commentId", $commentId);
        $commentId = $this->getId();
        $query->execute();
        $numLikes = $query->rowCount();

        $query = $this->con->prepare("SELECT * FROM dislikes WHERE commentId = :commentId");
        $query->bindParam(":commentId", $commentId);
        $query->execute();
        $numDisikes = $query->rowCount();
