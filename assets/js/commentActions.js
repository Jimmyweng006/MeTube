postComment = (button, postedBy, videoId, replyTo, containerClass) => {
...
likeComment = (commentId, button, videoId) => {
...
dislikeComment = (commentId, button, videoId) => {
...
getReplies = (commentId, button, videoId) => {
